...
export const translations: Record<'ja' | 'en', Translations> = {
  ja: {
    home: {
      ...
      adaptiveTitle: '🧠 成長型トレーニング',
      adaptiveSubtext: 'レベルに合わせて難易度が調整',
      adaptiveDetail: '',
    ...
    training: {
      adaptive: '成長型 Multi-N-Back トレーニング',
      fixed: '固定型 Multi-N-Back トレーニング',
      level: 'N-レベル',
      trial: '試行',
      score: 'スコア',
    ...
    settings: {
      ...
      adaptiveNLevel: '成長型 初期N-レベル',
      adaptiveNDescription: '成長型トレーニングの開始難易度',
  ...
  en: {
    home: {
      ...
      adaptiveTitle: '🧠 Growth Training',
      adaptiveSubtext: 'Difficulty adjusts to your level',
      adaptiveDetail: '',
      fixedTitle: '⚡ Fixed Training',
      fixedSubtext: 'Fixed difficulty',
      fixedDetail: '',
    },
    training: {
      adaptive: 'Growth Multi-N-Back Training',
      fixed: 'Fixed Multi-N-Back Training',
      level: 'N-Level',
      trial: 'Trial',
      score: 'Score',
    ...
    settings: {
      ...
      adaptiveNLevel: 'Growth Initial N-Level',
      adaptiveNDescription: 'Starting difficulty for growth training',
